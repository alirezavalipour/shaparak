@extends("layouts.panel",['page' => 'response-create' ])
...
@section("content")
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item small">ایجاد نتایج</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header card-color font-weight-bold text-white">ایجاد نتایج</div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <form action="{{ action(  '\Shaparak\Http\Controller\Client\ResponsesController@store') }}" method="post">
                            ...
                            <div class="row form-sheba">
                                ...
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <input id="tracking_number" class="form-control" value="{{ old("tracking_number") }}" name="tracking_number">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="tracking_number_psp" class="small font-weight-bold">tracking_number_psp</label>
                                    <input id="tracking_number_psp" class="form-control" value="{{ old("tracking_number_psp") }}" name="tracking_number_psp">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                ...
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <input id="request_date" class="form-control" value="{{ old("request_date") }}" type="text">
                                ...
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <select id="request_type" class="form-control" name="request_type">
                                        @foreach(\Shaparak\Database\models\Response::requestType() as $key=>$type)
                                            <option {{ old("request_type" ) == $key ? 'selected' : ""}} value="{{$key}}">
                                                {{$type}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <input id="related_merchants" class="form-control" value="{{ old("related_merchants") }}" name="related_merchants">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="data" class="small font-weight-bold">data</label>
                                    <input id="data" class="form-control" value="{{ old("data") }}" name="data">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="request_rejection_reasons" class="small font-weight-bold">request_rejection_reasons</label>
                                    <input id="request_rejection_reasons" class="form-control" value="{{ old("request_rejection_reasons") }}" name="request_rejection_reasons">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="request_details" class="small font-weight-bold">request_details</label>
                                    <input id="request_details" class="form-control" value="{{ old("request_details") }}" name="request_details">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="success" class="small font-weight-bold">success</label>
                                    <input id="success" class="form-control" value="{{ old("success") }}" name="success">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
