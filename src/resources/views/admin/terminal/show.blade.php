@extends("layouts.panel",['page' => 'terminal-show' ])
...
@section("content")
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item small">ویرایش پایانه</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header card-color font-weight-bold text-white">ویرایش پایانه</div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <form action="{{ action(  '\Shaparak\Http\Controller\Client\TerminalsController@store') }}" method="post">
                            ...
                            <div class="row form-sheba">
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <input id="acceptor_id" class="form-control" value="{{ old("acceptor_id", $terminal->acceptor_id) }}" name="acceptor_id">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="sequence" class="small font-weight-bold">sequence</label>
                                    <input id="sequence" class="form-control" value="{{ old("sequence", $terminal->sequence) }}" name="sequence">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="terminalNumber" class="small font-weight-bold">terminalNumber</label>
                                    <input id="terminalNumber" class="form-control" value="{{ old("terminalNumber", $terminal->terminalNumber) }}" name="terminalNumber">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="serialNumber" class="small font-weight-bold">serialNumber</label>
                                    <input id="serialNumber" class="form-control" value="{{ old("serialNumber", $terminal->serialNumber) }}" name="serialNumber">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="setupDate" class="small font-weight-bold">setupDate</label>
                                    <input id="setupDate" class="form-control" value="{{ old("setupDate", $terminal->setupDate) }}" type="text">
                                ...
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <input id="hardwareBrand" class="form-control" value="{{ old("hardwareBrand", $terminal->hardwareBrand) }}" name="hardwareBrand">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="hardwareModel" class="small font-weight-bold">hardwareModel</label>
                                    <input id="hardwareModel" class="form-control" value="{{ old("hardwareModel", $terminal->hardwareModel) }}" name="hardwareModel">
                                </div>
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <select id="terminalType" class="form-control" name="terminalType">
                                        @foreach(\Shaparak\Database\models\Terminal::terminalTypes() as $key=>$type)
                                            <option {{ old("terminalType", $terminal->terminalType) == $key ? 'selected' : ""}} value="{{$key}}">
                                                {{$type}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-sm-4 col-12 form-group">
                                    ...
                                    <input id="accessAddress" class="form-control" value="{{ old("accessAddress", $terminal->accessAddress) }}" name="accessAddress"></div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="accessPort" class="small font-weight-bold">accessPort</label>
                                    <input id="accessPort" class="form-control" value="{{ old("accessPort", $terminal->accessPort) }}" name="accessPort"></div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="callbackAddress" class="small font-weight-bold">callbackAddress</label>
                                    <input id="callbackAddress" class="form-control" value="{{ old("callbackAddress", $terminal->callbackAddress) }}" name="callbackAddress"></div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="callbackPort" class="small font-weight-bold">callbackPort</label>
                                    <input id="callbackPort" class="form-control" value="{{ old("callbackPort", $terminal->callbackPort) }}" name="callbackPort"></div>
                                <div class="col-sm-4 col-12 form-group">
                                    <label for="description" class="small font-weight-bold">description</label>
                                    <input id="description" class="form-control" value="{{ old("description", $terminal->description) }}" name="description">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
