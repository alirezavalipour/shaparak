...
use Shaparak\Service\Requests\WriteRequest\ReactiveTerminal;
use Shaparak\Service\Requests\WriteRequest\ShopProviderRegister;

class ReactivateTerminalController extends Controller
{
    ...
    public function send(Request $request, $id)
    {
        ...
        $response = ShaparakFacade::make(ReactiveTerminal::class)->sendRequest($merchant, $merchant->shops, $merchant->contract);
