...
class ChangeShopController extends Controller
{
    ...
    public function send(Request $request, $id)
    {
        ...
        $response = ShaparakFacade::make(ChangeShopInformation::class)->sendRequest($merchant, $merchant->shops, $merchant->contract);
