...
class ChangeInformationController extends Controller
{
    ...
    public function send(Request $request, $id)
    {
        ...
        $response = ShaparakFacade::make(ChangeInformation::class)
            ->sendRequest( $merchant, $merchant->shops, $merchant->contract);
